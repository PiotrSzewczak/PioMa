...
class DynamicSearch:
    ...
    def dynamic_search(self, searched_value: str) -> list[str]:
        """
        ...
        Returns:
            A list of Apartment entities matching the search criteria, or an empty list when no criteria is
        """
